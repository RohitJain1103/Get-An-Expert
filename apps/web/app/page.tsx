    ...
    <div className="flex flex-1 flex-col bg-zinc-50 font-sans dark:bg-black">
      <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-20">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-600 dark:text-zinc-400">
          ...
          summary of where you&apos;re stuck and returns a diagnosis plus the
          exact prompt to try next. The first pass is AI-assisted triage;
          human experts are joining soon.
        </p>
        ...
        <section className="mt-12">
          ...
          <ol className="mt-4 space-y-3 text-zinc-600 dark:text-zinc-400">
            ...
            <li>
              ...
              We diagnose why the session stalled and hand back one
              ready-to-paste prompt built to break the loop — clearly labeled
              as AI-assisted, with human experts on the way.
            </li>
          </ol>
        </section>
        ...
        <section className="mt-12 rounded-xl border border-zinc-200 bg-white p-5 text-sm text-zinc-600 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-400">
          <p>
            ...
            today, the first response is generated by AI (Claude) from the
            summary you approve — it&apos;s labeled that way in every reply.
            We never sell your data, never use it for advertising, and never
            train models on it. Requests auto-delete after 30 days, and every
            response includes a one-click deletion link.
          </p>
        </section>
      </main>
